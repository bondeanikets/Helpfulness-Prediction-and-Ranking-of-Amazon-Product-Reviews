...
"""
Created on Mon Oct 24 12:51:02 2016
...
f = open('store_wholedata.pckl', 'rb')
...
plt.xlabel('Ratings')
plt.savefig('1.Histogram_Overall_Rating_wholedata.png', dpi=900, bbox_inches='tight')
...
plt.savefig('2.Distribution_of_Helpfulness_wholedata.png', dpi=900, bbox_inches='tight')
...
plt.savefig('3.Histogram_Helpfulness_wholedata.png', dpi=900, bbox_inches='tight')
...
plt.figure(fig)
fig = fig + 1
plt.bar(index, a1[0], bar_width, color = 'g', alpha = .8, label = 'Not Helpful (<25%)')
plt.bar(index + bar_width, b1[0], bar_width, color = 'r', alpha = .8, label = 'Helpful (>75%)')
plt.ylim(0,100)
...
plt.savefig('4.Overall Ratings VS the Helpfulness_wholedata.png', dpi=900, bbox_inches='tight')
plt.show()
...
plt.axis("off")
plt.savefig('5.Wordcloud for Negative Reviews_wholedata.png', dpi=1200)
...
plt.axis("off")
plt.savefig('6.Wordcloud for Positive Reviews_wholedata.png', dpi=1200)
...
plt.savefig('7.Histogram of Number of words_wholedata.png', dpi=900, bbox_inches='tight')
...
plt.savefig('8.Variance of Polarity with respect to Overall Ratings_wholedata.png', dpi=900, bbox_inches='tight')
...
plt.savefig('9.Number of Sentences VS Helpfulness_wholedata.png', dpi=900, bbox_inches='tight')
